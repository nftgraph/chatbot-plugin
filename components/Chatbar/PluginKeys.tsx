        ...
        >
          <div className="fixed inset-0 z-10 overflow-y-auto">
            <div className="flex min-h-screen items-center justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
              ...
              <div
                ref={modalRef}
                className="text-black dark:text-white dark:border-netural-400 inline-block max-h-[400px] sm:max-h-[100vh] transform overflow-hidden rounded-lg border border-gray-300 bg-white px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all dark:bg-[#202123] sm:my-8 sm:max-h-[900px] sm:w-full sm:max-w-lg sm:p-6 sm:align-middle"
                role="dialog"
              >
